...
class SMslalom : public Section_management{
    ...
    private:
        ...
        Main_Section lslalompra[100]={
            ...
            {LINETRACER,{25,2,0.5,8,LEFT,0}, DISTANCE,{8},-1,{}, UPDATE_ALL},
            /*スラロム登った*/
            {WALKER,{0,-10},TURN,{-50},-1,{}, UPDATE_ANG},
            //{STRAIGHT,{10,1,0.5,3,-50}, DISTANCE,{1},-1,{}, UPDATE_DIST},
            /*{WALKER,{0,0}, TIMEJUDGE,{50}, UNUPDATE},*/
            {CURVE,{10,2,0.6,13,0,21}, TURN,{48},-1,{}, UNUPDATE},
            {CURVE,{10,2,0.6,13,0,-16.5}, TURN,{-33},-1,{}, UNUPDATE},
            {CURVE,{10,2,0.6,13,0,25}, TURN,{-18},-1,{}, UNUPDATE},
            {CURVE,{10,2,0.6,13,0,28.5}, TURN,{1},-1,{}, UNUPDATE},
            {WALKER,{5,0},DISTANCE,{2.5},SONARJUDGE,{16.5},UPDATE_DIST},
            {CURVE,{10,2,0.6,13,0,26}, TURN,{8},-1,{}, UNUPDATE},
            {STRAIGHT,{10,2,0.6,12,8}, DISTANCE,{4},-1,{},UPDATE_DIST},
            {WALKER,{10,0},DISTANCE,{12},-1,{},UPDATE_DIST},
            //踊り場旋回
            {WALKER,{0,-10},TURN,{-85},-1,{}, UPDATE_DIST},
            {STRAIGHT,{10,1,0.6,10,-85}, DISTANCE,{8},-1,{}, UPDATE_DIST},
            //{WALKER,{0,0}, DISTANCE,{12000},-1,{}, UNDEFINED},
            //{WALKER,{0,-10}, TURN,{-120},-1,{}, UPDATE_DIST},
            {CURVE,{10,2,0.6,11,0,-29.5},TURN,{-95} ,-1,{}, UNUPDATE},
            {CURVE,{10,2,0.6,6,0,29},TURN,{-85} ,-1,{}, UNUPDATE},
    ...
    Main_Section rslalompra[100]={
            ...
            //{STRAIGHT,{10,1,0.5,3,-50}, DISTANCE,{1},-1,{}, UPDATE_DIST},
            /*{WALKER,{0,0}, TIMEJUDGE,{50}, UNUPDATE},*/
            {CURVE,{10,2,0.6,13,0,-22.5}, TURN,{-48},-1,{}, UNUPDATE},
            {CURVE,{10,2,0.6,13,0,17.5}, TURN,{33},-1,{}, UNUPDATE},
            {CURVE,{10,2,0.6,13,0,-26}, TURN,{30},-1,{}, UNUPDATE},
            {CURVE,{10,2,0.6,13,0,-27.5}, TURN,{-1},-1,{}, UNUPDATE},
            {WALKER,{5,0},DISTANCE,{2.5},SONARJUDGE,{16.5},UPDATE_DIST},
            {CURVE,{10,2,0.6,13,0,-26}, TURN,{-8},-1,{}, UNUPDATE},
            {STRAIGHT,{10,2,0.6,12,-8}, DISTANCE,{4},-1,{},UPDATE_DIST},
            {WALKER,{10,0},DISTANCE,{12},-1,{},UPDATE_DIST},
            ...
            //{WALKER,{0,0}, DISTANCE,{12000},-1,{}, UNDEFINED},
            //{WALKER,{0,-10}, TURN,{-120},-1,{}, UPDATE_DIST},
            {CURVE,{10,2,0.6,11,0,28.5},TURN,{100} ,-1,{}, UNUPDATE},
            {CURVE,{10,2,0.6,6,0,-28},TURN,{85} ,-1,{}, UNUPDATE},
            {WALKER,{10,0},DISTANCE,{15},-1,{},UPDATE_DIST},
            {CURVE,{10,1,0.6,6,0,-18},BRIGHT,{-0.1,-1}, -1,{},UNUPDATE},
